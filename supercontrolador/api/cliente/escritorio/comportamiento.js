window.onload = function(){
    ...
    console.log("elusuarioes:",usuario)
    fetch("../../servidor/?o=listadoaplicacionesusuarios&usuarios2="+usuario)         // LLamo a un microservicio que me da la lista de aplicaciones
        .then(response => {
          return response.json();                       // Quiero que el servidor me devuelva un json
        })
        .then(data => { 
