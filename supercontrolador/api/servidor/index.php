<?php
	...
	if(isset($_GET['o'])){
        ...
        $datos = json_decode($json, true);																					// Me aseguro que ese json tenga una forma que PHP pueda entender
			...
			case "listadoaplicacionesusuarios":
				echo $conexion->listadoAplicacionesUsuarios(); 
				break;

			case "listatablasaplicacionaplicacion":
				echo $conexion->listatablasaplicacionaplicacion();
				break;	
